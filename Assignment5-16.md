...
- [Assessment using Reliability Demonstration Chart (RDC)](#3-assessment-using-reliability-demonstration-chart)
    ...
    - [Finding MTTF<sub>min</sub> and justification of the approach](#33-finding-mttfmin-and-justification-of-the-approach)
    - [Finding 2 X MTTF<sub>min</sub> and 1/2 X MTTF<sub>min</sub>](#34-finding-2-mttfmin-and-12-mttfmin)
